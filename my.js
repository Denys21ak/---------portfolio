...
// const res2 = document.getElementsByClassName('button hero-button');
// console.log(res2);
...
document.getElementById('button hero-button').onclick = function() { 
	document.getElementById('button hero-button').style.display = "none";
	document.getElementById('bt').style.display = "none";
 }

document.querySelector('.button hero-button').addEventListener('click', () => {
	document.querySelector('.button hero-button').classList.toggle('active');
 });

const res1 = document.querySelector('[data-say-hi]');
const value = res1.getAttribute('data-say-hi');
console.log(value);




res2 = document.getElementsByTagName('Li');
//elem = res2.lastElementChild;
let elem;
for (item of res2){
...
res3 = document.getElementsByClassName('like');
...
const str = 'мама,мыkр,аму'; // исходная строка
...
let arr1 = [];
function dublicat(n, name) {
  for (i = 0; i < n; i++) {
    let a = arr1.push(name);
  }
  console.log(arr1);
}
dublicat(2, "f");
...
// var first = [ 1, 2, 3, 4, 5 [5]];
// var second = [ 2, 2, 3, 4, 5 [5]];
 
// var isEqual = first[1].toString() === second[1].toString();
// if(isEqual === true){
//     console.log("Другий елемент масиву одникові");
// } else{
//     console.log("не одинакові елементи");
// }
